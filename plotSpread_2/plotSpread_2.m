function handles = plotSpread_2(varargin)
%plotSpread_2 plots distributions of points by spreading them around the y-axis
%
% SYNOPSIS: handles = plotSpread_2(data,binWidth,spreadFcn,xNames,showMM,xValues)
%           handles = plotSpread_2(ah,...)
%
...
parserObj.FunctionName = 'plotSpread_2';
